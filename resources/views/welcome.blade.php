...
<div class="hero-image">
    <div class="hero-content">
        <div class="col-md-4 hero-text">
            ...
            <p>Here we believe in making energy storage affordable without compromising on quality.</p>
            ...
            <div class="col-md-6 col-sm-12 col-lg-4 product">
                <a href="{{ route('shop.show', $product->slug) }}" class="custom-card">
                    <div class="card view overlay zoom">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{ $product->name }}<span class="float-right">R {{ format($product->price) }}</span></h5>
